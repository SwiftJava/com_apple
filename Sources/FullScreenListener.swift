...
private typealias FullScreenListener_windowEnteringFullScreen_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func FullScreenListener_windowEnteringFullScreen_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias FullScreenListener_windowEnteredFullScreen_1_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func FullScreenListener_windowEnteredFullScreen_1( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias FullScreenListener_windowExitingFullScreen_2_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func FullScreenListener_windowExitingFullScreen_2( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias FullScreenListener_windowExitedFullScreen_3_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func FullScreenListener_windowExitedFullScreen_3( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
open class FullScreenListenerLocal_: JNILocalProxy<FullScreenListener, Any> {
    ...
    fileprivate static let _proxyClass: jclass = {
        ...
        natives.append( JNINativeMethod( name: strdup("__windowEnteringFullScreen"), signature: strdup("(JLcom/apple/eawt/AppEvent$FullScreenEvent;)V"), fnPtr: unsafeBitCast( FullScreenListener_windowEnteringFullScreen_0_thunk, to: UnsafeMutableRawPointer.self ) ) )
        ...
        natives.append( JNINativeMethod( name: strdup("__windowEnteredFullScreen"), signature: strdup("(JLcom/apple/eawt/AppEvent$FullScreenEvent;)V"), fnPtr: unsafeBitCast( FullScreenListener_windowEnteredFullScreen_1_thunk, to: UnsafeMutableRawPointer.self ) ) )
        ...
        natives.append( JNINativeMethod( name: strdup("__windowExitingFullScreen"), signature: strdup("(JLcom/apple/eawt/AppEvent$FullScreenEvent;)V"), fnPtr: unsafeBitCast( FullScreenListener_windowExitingFullScreen_2_thunk, to: UnsafeMutableRawPointer.self ) ) )
        ...
        natives.append( JNINativeMethod( name: strdup("__windowExitedFullScreen"), signature: strdup("(JLcom/apple/eawt/AppEvent$FullScreenEvent;)V"), fnPtr: unsafeBitCast( FullScreenListener_windowExitedFullScreen_3_thunk, to: UnsafeMutableRawPointer.self ) ) )
