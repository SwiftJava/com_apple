...
open class AquaMenuItemUI: javax_swing.BasicMenuItemUI {
    ...
    override open var acceleratorDelimiter: String! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "acceleratorDelimiter", fieldType: "Ljava/lang/String;", fieldCache: &AquaMenuItemUI.acceleratorDelimiter_FieldID, object: javaObject )
    ...
    override open var acceleratorFont: java_awt.Font! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "acceleratorFont", fieldType: "Ljava/awt/Font;", fieldCache: &AquaMenuItemUI.acceleratorFont_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var acceleratorForeground: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "acceleratorForeground", fieldType: "Ljava/awt/Color;", fieldCache: &AquaMenuItemUI.acceleratorForeground_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var acceleratorSelectionForeground: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "acceleratorSelectionForeground", fieldType: "Ljava/awt/Color;", fieldCache: &AquaMenuItemUI.acceleratorSelectionForeground_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Color( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var arrowIcon: javax_swing.Icon! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "arrowIcon", fieldType: "Ljavax/swing/Icon;", fieldCache: &AquaMenuItemUI.arrowIcon_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var checkIcon: javax_swing.Icon! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "checkIcon", fieldType: "Ljavax/swing/Icon;", fieldCache: &AquaMenuItemUI.checkIcon_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? javax_swing.IconForward( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var defaultTextIconGap: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "defaultTextIconGap", fieldType: "I", fieldCache: &AquaMenuItemUI.defaultTextIconGap_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var disabledForeground: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "disabledForeground", fieldType: "Ljava/awt/Color;", fieldCache: &AquaMenuItemUI.disabledForeground_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Color( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var menuDragMouseListener: javax_swing.MenuDragMouseListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "menuDragMouseListener", fieldType: "Ljavax/swing/event/MenuDragMouseListener;", fieldCache: &AquaMenuItemUI.menuDragMouseListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var menuItem: javax_swing.JMenuItem! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "menuItem", fieldType: "Ljavax/swing/JMenuItem;", fieldCache: &AquaMenuItemUI.menuItem_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var menuKeyListener: javax_swing.MenuKeyListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "menuKeyListener", fieldType: "Ljavax/swing/event/MenuKeyListener;", fieldCache: &AquaMenuItemUI.menuKeyListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var mouseInputListener: javax_swing.MouseInputListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "mouseInputListener", fieldType: "Ljavax/swing/event/MouseInputListener;", fieldCache: &AquaMenuItemUI.mouseInputListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var oldBorderPainted: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "oldBorderPainted", fieldType: "Z", fieldCache: &AquaMenuItemUI.oldBorderPainted_FieldID, object: javaObject )
    ...
    override open var propertyChangeListener: /* interface java.beans.PropertyChangeListener */ UnavailableProtocol! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "propertyChangeListener", fieldType: "Ljava/beans/PropertyChangeListener;", fieldCache: &AquaMenuItemUI.propertyChangeListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var selectionBackground: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "selectionBackground", fieldType: "Ljava/awt/Color;", fieldCache: &AquaMenuItemUI.selectionBackground_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Color( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var selectionForeground: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "selectionForeground", fieldType: "Ljava/awt/Color;", fieldCache: &AquaMenuItemUI.selectionForeground_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Color( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    private static var createUI_MethodID_1: jmethodID?

    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaMenuItemUI", classCache: &AquaMenuItemUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_1, args: &__args, locals: &__locals )
    ...
    private static var addListeners_MethodID_2: jmethodID?

    open func addListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addListeners", methodSig: "()V", methodCache: &AquaMenuItemUI.addListeners_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func doClick( arg0: javax_swing.MenuSelectionManager? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "doClick", methodSig: "(Ljavax/swing/MenuSelectionManager;)V", methodCache: &AquaMenuItemUI.doClick_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func getPreferredMenuItemSize( arg0: javax_swing.JComponent?, arg1: javax_swing.Icon?, arg2: javax_swing.Icon?, arg3: Int ) -> java_awt.Dimension! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreferredMenuItemSize", methodSig: "(Ljavax/swing/JComponent;Ljavax/swing/Icon;Ljavax/swing/Icon;I)Ljava/awt/Dimension;", methodCache: &AquaMenuItemUI.getPreferredMenuItemSize_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getPropertyPrefix() -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPropertyPrefix", methodSig: "()Ljava/lang/String;", methodCache: &AquaMenuItemUI.getPropertyPrefix_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func installListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &AquaMenuItemUI.installListeners_MethodID_6, args: &__args, locals: &__locals )
    }


    /// public void com.apple.laf.AquaMenuItemUI.paintBackground(java.awt.Graphics,javax.swing.JComponent,int,int)

    private static var paintBackground_MethodID_7: jmethodID?
    ...
    open func paintBackground( arg0: java_awt.Graphics?, arg1: javax_swing.JComponent?, arg2: Int, arg3: Int ) {
        ...
        __args[3] = jvalue( i: jint(arg3) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintBackground", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;II)V", methodCache: &AquaMenuItemUI.paintBackground_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var paintMenuItem_MethodID_8: jmethodID?
    ...
    open func paintMenuItem( arg0: java_awt.Graphics?, arg1: javax_swing.JComponent?, arg2: javax_swing.Icon?, arg3: javax_swing.Icon?, arg4: java_awt.Color?, arg5: java_awt.Color?, arg6: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintMenuItem", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;Ljavax/swing/Icon;Ljavax/swing/Icon;Ljava/awt/Color;Ljava/awt/Color;I)V", methodCache: &AquaMenuItemUI.paintMenuItem_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    private static var removeListeners_MethodID_9: jmethodID?

    open func removeListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeListeners", methodSig: "()V", methodCache: &AquaMenuItemUI.removeListeners_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    override open func uninstallListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "()V", methodCache: &AquaMenuItemUI.uninstallListeners_MethodID_11, args: &__args, locals: &__locals )
    }


    /// public void com.apple.laf.AquaMenuItemUI.update(java.awt.Graphics,javax.swing.JComponent)

    private static var update_MethodID_12: jmethodID?
    ...
    open func update( arg0: java_awt.Graphics?, arg1: javax_swing.JComponent? ) {
        ...
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        __args[1] = JNIType.toJava( value: arg1, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &AquaMenuItemUI.update_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    private static var updateListenersForScreenMenuItem_MethodID_13: jmethodID?

    open func updateListenersForScreenMenuItem() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "updateListenersForScreenMenuItem", methodSig: "()V", methodCache: &AquaMenuItemUI.updateListenersForScreenMenuItem_MethodID_13, args: &__args, locals: &__locals )
    }
