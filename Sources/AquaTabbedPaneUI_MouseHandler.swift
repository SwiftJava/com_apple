...
open class AquaTabbedPaneUI_MouseHandler: javax_swing.MouseInputAdapter, java_awt.ActionListener {
    ...
    open func mousePressed( arg0: java_awt.MouseEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mousePressed", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaTabbedPaneUI_MouseHandler.mousePressed_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func mouseReleased( arg0: java_awt.MouseEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseReleased", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaTabbedPaneUI_MouseHandler.mouseReleased_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func mouseDragged( arg0: java_awt.MouseEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseDragged", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaTabbedPaneUI_MouseHandler.mouseDragged_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func actionPerformed( e: java_awt.ActionEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "actionPerformed", methodSig: "(Ljava/awt/event/ActionEvent;)V", methodCache: &AquaTabbedPaneUI_MouseHandler.actionPerformed_MethodID_5, args: &__args, locals: &__locals )
    }
