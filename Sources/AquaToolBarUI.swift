...
open class AquaToolBarUI: javax_swing.BasicToolBarUI {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "com.apple.laf.AquaToolBarUI", file, line ) {
            return nil
        }
    ...
    /// private static com.apple.laf.AquaUtils$LazySingleton com.apple.laf.AquaToolBarUI.toolBarBorder
    ...
    private static var setBorderToNonRollover_MethodID_4: jmethodID?

    override open func setBorderToNonRollover( arg0: java_awt.Component? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBorderToNonRollover", methodSig: "(Ljava/awt/Component;)V", methodCache: &AquaToolBarUI.setBorderToNonRollover_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var setBorderToNormal_MethodID_5: jmethodID?

    override open func setBorderToNormal( arg0: java_awt.Component? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBorderToNormal", methodSig: "(Ljava/awt/Component;)V", methodCache: &AquaToolBarUI.setBorderToNormal_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    override open func setBorderToRollover( arg0: java_awt.Component? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBorderToRollover", methodSig: "(Ljava/awt/Component;)V", methodCache: &AquaToolBarUI.setBorderToRollover_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    override open func createFloatingWindow( arg0: javax_swing.JToolBar? ) -> javax_swing.RootPaneContainer! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFloatingWindow", methodSig: "(Ljavax/swing/JToolBar;)Ljavax/swing/RootPaneContainer;", methodCache: &AquaToolBarUI.createFloatingWindow_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
