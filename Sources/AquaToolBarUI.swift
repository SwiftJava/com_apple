...
open class AquaToolBarUI: javax_swing.BasicToolBarUI {
    ...
    private static var setBorderToNonRollover_MethodID_3: jmethodID?

    open func setBorderToNonRollover( arg0: java_awt.Component? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBorderToNonRollover", methodSig: "(Ljava/awt/Component;)V", methodCache: &AquaToolBarUI.setBorderToNonRollover_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var setBorderToNormal_MethodID_4: jmethodID?

    open func setBorderToNormal( arg0: java_awt.Component? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBorderToNormal", methodSig: "(Ljava/awt/Component;)V", methodCache: &AquaToolBarUI.setBorderToNormal_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var setBorderToRollover_MethodID_5: jmethodID?

    open func setBorderToRollover( arg0: java_awt.Component? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBorderToRollover", methodSig: "(Ljava/awt/Component;)V", methodCache: &AquaToolBarUI.setBorderToRollover_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func createFloatingWindow( arg0: javax_swing.JToolBar? ) -> javax_swing.RootPaneContainer! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFloatingWindow", methodSig: "(Ljavax/swing/JToolBar;)Ljavax/swing/RootPaneContainer;", methodCache: &AquaToolBarUI.createFloatingWindow_MethodID_6, args: &__args, locals: &__locals )
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaToolBarUI", classCache: &AquaToolBarUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getToolBarBorder_MethodID_8: jmethodID?

    open class func getToolBarBorder() -> javax_swing.Border! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaToolBarUI", classCache: &AquaToolBarUIJNIClass, methodName: "getToolBarBorder", methodSig: "()Ljavax/swing/border/Border;", methodCache: &getToolBarBorder_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
