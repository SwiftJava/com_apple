...
open class AquaScrollPaneUI: javax_swing.BasicScrollPaneUI {
    ...
    private static var createMouseWheelListener_MethodID_2: jmethodID?

    override open func createMouseWheelListener() -> java_awt.MouseWheelListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createMouseWheelListener", methodSig: "()Ljava/awt/event/MouseWheelListener;", methodCache: &AquaScrollPaneUI.createMouseWheelListener_MethodID_2, args: &__args, locals: &__locals )
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaScrollPaneUI", classCache: &AquaScrollPaneUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
