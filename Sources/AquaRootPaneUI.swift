...
open class AquaRootPaneUI: javax_swing.BasicRootPaneUI, javax_swing.AncestorListener, java_awt.WindowListener, java_awt.ContainerListener {
    ...
    open func ancestorRemoved( event: javax_swing.AncestorEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: event != nil ? event! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "ancestorRemoved", methodSig: "(Ljavax/swing/event/AncestorEvent;)V", methodCache: &AquaRootPaneUI.ancestorRemoved_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func propertyChange( arg0: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &AquaRootPaneUI.propertyChange_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaRootPaneUI", classCache: &AquaRootPaneUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_16, args: &__args, locals: &__locals )
    ...
    open func installUI( arg0: javax_swing.JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaRootPaneUI.installUI_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallUI( arg0: javax_swing.JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaRootPaneUI.uninstallUI_MethodID_18, args: &__args, locals: &__locals )
    }
    ...
    private static var ancestorMoved_MethodID_19: jmethodID?

    open func ancestorMoved( event: javax_swing.AncestorEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: event != nil ? event! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "ancestorMoved", methodSig: "(Ljavax/swing/event/AncestorEvent;)V", methodCache: &AquaRootPaneUI.ancestorMoved_MethodID_19, args: &__args, locals: &__locals )
    }
    ...
    private static var componentAdded_MethodID_20: jmethodID?

    open func componentAdded( e: java_awt.ContainerEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: e != nil ? e! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "componentAdded", methodSig: "(Ljava/awt/event/ContainerEvent;)V", methodCache: &AquaRootPaneUI.componentAdded_MethodID_20, args: &__args, locals: &__locals )
    }
    ...
    private static var componentRemoved_MethodID_21: jmethodID?

    open func componentRemoved( e: java_awt.ContainerEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: e != nil ? e! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "componentRemoved", methodSig: "(Ljava/awt/event/ContainerEvent;)V", methodCache: &AquaRootPaneUI.componentRemoved_MethodID_21, args: &__args, locals: &__locals )
    }
