...
open class AppEvent_AboutEvent: AppEvent {
    ...
    private static var AppEvent_AboutEventJNIClass: jclass?
    ...
    override open var source: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "source", fieldType: "Ljava/lang/Object;", fieldCache: &AppEvent_AboutEvent.source_FieldID, object: javaObject )
