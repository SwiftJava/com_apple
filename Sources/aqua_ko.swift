...
open class aqua_ko: java_util.ListResourceBundle {
    ...
    private static var aqua_koJNIClass: jclass?
    ...
    override open var parent: java_util.ResourceBundle! {
        get {
            ...
            let __value = JNIField.GetObjectField( fieldName: "parent", fieldType: "Ljava/util/ResourceBundle;", fieldCache: &aqua_ko.parent_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? java_util.ResourceBundle( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = JNIType.toJava( value: newValue != nil ? newValue! as JNIObject : nil, locals: &__locals )
            JNIField.SetObjectField( fieldName: "parent", fieldType: "Ljava/util/ResourceBundle;", fieldCache: &aqua_ko.parent_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    /// public com.apple.laf.resources.aqua_ko()
    ...
    public convenience init() {
        ...
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "com/apple/laf/resources/aqua_ko", classCache: &aqua_ko.aqua_koJNIClass, methodSig: "()V", methodCache: &aqua_ko.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    /// protected final java.lang.Object[][] com.apple.laf.resources.aqua_ko.getContents()
    ...
    override open func getContents() -> [[JavaObject]]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getContents", methodSig: "()[[Ljava/lang/Object;", methodCache: &aqua_ko.getContents_MethodID_2, args: &__args, locals: &__locals )
