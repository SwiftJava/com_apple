...
open class aqua_it: java_util.ListResourceBundle {
    ...
    override open var parent: java_util.ResourceBundle! {
        get {
            ...
            let __value = JNIField.GetObjectField( fieldName: "parent", fieldType: "Ljava/util/ResourceBundle;", fieldCache: &aqua_it.parent_FieldID, object: javaObject, locals: &__locals )
