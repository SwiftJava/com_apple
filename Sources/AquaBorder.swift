...
open class AquaBorder: java_swift.JavaObject, javax_swing.Border, javax_swing.UIResource {
    ...
    open func getBorderInsets( c: java_awt.Component? ) -> java_awt.Insets! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBorderInsets", methodSig: "(Ljava/awt/Component;)Ljava/awt/Insets;", methodCache: &AquaBorder.getBorderInsets_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func isBorderOpaque() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isBorderOpaque", methodSig: "()Z", methodCache: &AquaBorder.isBorderOpaque_MethodID_5, args: &__args, locals: &__locals )
    ...
    private static var isFocused_MethodID_6: jmethodID?

    open func isFocused( arg0: java_awt.Component? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFocused", methodSig: "(Ljava/awt/Component;)Z", methodCache: &AquaBorder.isFocused_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
