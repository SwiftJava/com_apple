...
open class AquaSliderUI: javax_swing.BasicSliderUI {
    ...
    open var disabledTickColor: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "disabledTickColor", fieldType: "Ljava/awt/Color;", fieldCache: &AquaSliderUI.disabledTickColor_FieldID, object: javaObject )
    ...
    open var fIsDragging: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "fIsDragging", fieldType: "Z", fieldCache: &AquaSliderUI.fIsDragging_FieldID, object: javaObject )
    ...
    open var tickColor: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "tickColor", fieldType: "Ljava/awt/Color;", fieldCache: &AquaSliderUI.tickColor_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Color( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var changeListener: javax_swing.ChangeListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &AquaSliderUI.changeListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var componentListener: java_awt.ComponentListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "componentListener", fieldType: "Ljava/awt/event/ComponentListener;", fieldCache: &AquaSliderUI.componentListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var contentRect: java_awt.Rectangle! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "contentRect", fieldType: "Ljava/awt/Rectangle;", fieldCache: &AquaSliderUI.contentRect_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var focusInsets: java_awt.Insets! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "focusInsets", fieldType: "Ljava/awt/Insets;", fieldCache: &AquaSliderUI.focusInsets_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var focusListener: java_awt.FocusListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "focusListener", fieldType: "Ljava/awt/event/FocusListener;", fieldCache: &AquaSliderUI.focusListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var focusRect: java_awt.Rectangle! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "focusRect", fieldType: "Ljava/awt/Rectangle;", fieldCache: &AquaSliderUI.focusRect_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Rectangle( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var insetCache: java_awt.Insets! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "insetCache", fieldType: "Ljava/awt/Insets;", fieldCache: &AquaSliderUI.insetCache_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Insets( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var labelRect: java_awt.Rectangle! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "labelRect", fieldType: "Ljava/awt/Rectangle;", fieldCache: &AquaSliderUI.labelRect_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Rectangle( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var leftToRightCache: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "leftToRightCache", fieldType: "Z", fieldCache: &AquaSliderUI.leftToRightCache_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var propertyChangeListener: /* interface java.beans.PropertyChangeListener */ UnavailableProtocol! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "propertyChangeListener", fieldType: "Ljava/beans/PropertyChangeListener;", fieldCache: &AquaSliderUI.propertyChangeListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var scrollListener: javax_swing.BasicSliderUI_ScrollListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "scrollListener", fieldType: "Ljavax/swing/plaf/basic/BasicSliderUI$ScrollListener;", fieldCache: &AquaSliderUI.scrollListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var scrollTimer: javax_swing.Timer! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "scrollTimer", fieldType: "Ljavax/swing/Timer;", fieldCache: &AquaSliderUI.scrollTimer_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var slider: javax_swing.JSlider! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "slider", fieldType: "Ljavax/swing/JSlider;", fieldCache: &AquaSliderUI.slider_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var thumbRect: java_awt.Rectangle! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "thumbRect", fieldType: "Ljava/awt/Rectangle;", fieldCache: &AquaSliderUI.thumbRect_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Rectangle( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var tickRect: java_awt.Rectangle! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "tickRect", fieldType: "Ljava/awt/Rectangle;", fieldCache: &AquaSliderUI.tickRect_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Rectangle( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var trackBuffer: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "trackBuffer", fieldType: "I", fieldCache: &AquaSliderUI.trackBuffer_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var trackListener: javax_swing.BasicSliderUI_TrackListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "trackListener", fieldType: "Ljavax/swing/plaf/basic/BasicSliderUI$TrackListener;", fieldCache: &AquaSliderUI.trackListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var trackRect: java_awt.Rectangle! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "trackRect", fieldType: "Ljava/awt/Rectangle;", fieldCache: &AquaSliderUI.trackRect_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Rectangle( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaSliderUI", classCache: &AquaSliderUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func applySizeFor( arg0: javax_swing.JComponent?, arg1: /* class apple.laf.JRSUIConstants$Size */ UnavailableObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "applySizeFor", methodSig: "(Ljavax/swing/JComponent;Lapple/laf/JRSUIConstants$Size;)V", methodCache: &AquaSliderUI.applySizeFor_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    override open func calculateThumbLocation() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "calculateThumbLocation", methodSig: "()V", methodCache: &AquaSliderUI.calculateThumbLocation_MethodID_4, args: &__args, locals: &__locals )
    }


    /// protected void com.apple.laf.AquaSliderUI.calculateThumbSize()

    private static var calculateThumbSize_MethodID_5: jmethodID?

    override open func calculateThumbSize() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "calculateThumbSize", methodSig: "()V", methodCache: &AquaSliderUI.calculateThumbSize_MethodID_5, args: &__args, locals: &__locals )
    }


    /// protected void com.apple.laf.AquaSliderUI.calculateTickRect()

    private static var calculateTickRect_MethodID_6: jmethodID?

    override open func calculateTickRect() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "calculateTickRect", methodSig: "()V", methodCache: &AquaSliderUI.calculateTickRect_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func createChangeListener( arg0: javax_swing.JSlider? ) -> javax_swing.ChangeListener! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createChangeListener", methodSig: "(Ljavax/swing/JSlider;)Ljavax/swing/event/ChangeListener;", methodCache: &AquaSliderUI.createChangeListener_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createTrackListener_MethodID_8: jmethodID?

    open func createTrackListener( arg0: javax_swing.JSlider? ) -> javax_swing.BasicSliderUI_TrackListener! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createTrackListener", methodSig: "(Ljavax/swing/JSlider;)Ljavax/swing/plaf/basic/BasicSliderUI$TrackListener;", methodCache: &AquaSliderUI.createTrackListener_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func installListeners( arg0: javax_swing.JSlider? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "(Ljavax/swing/JSlider;)V", methodCache: &AquaSliderUI.installListeners_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    open func paintThumb( arg0: java_awt.Graphics?, arg1: javax_swing.JComponent?, arg2: /* class apple.laf.JRSUIConstants$Orientation */ UnavailableObject?, arg3: /* class apple.laf.JRSUIConstants$State */ UnavailableObject? ) {
        var __locals = [jobject]()
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintThumb", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;Lapple/laf/JRSUIConstants$Orientation;Lapple/laf/JRSUIConstants$State;)V", methodCache: &AquaSliderUI.paintThumb_MethodID_12, args: &__args, locals: &__locals )
    }

    open func paintThumb( _ _arg0: java_awt.Graphics?, _ _arg1: javax_swing.JComponent?, _ _arg2: /* class apple.laf.JRSUIConstants$Orientation */ UnavailableObject?, _ _arg3: /* class apple.laf.JRSUIConstants$State */ UnavailableObject? ) {
    ...
    private static var paintTicks_MethodID_13: jmethodID?

    open func paintTicks( arg0: java_awt.Graphics? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintTicks", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &AquaSliderUI.paintTicks_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func paintTrack( arg0: java_awt.Graphics?, arg1: javax_swing.JComponent?, arg2: /* class apple.laf.JRSUIConstants$Orientation */ UnavailableObject?, arg3: /* class apple.laf.JRSUIConstants$State */ UnavailableObject? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 4 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        __args[1] = JNIType.toJava( value: arg1, locals: &__locals )
        __args[2] = JNIType.toJava( value: arg2, locals: &__locals )
        __args[3] = JNIType.toJava( value: arg3, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintTrack", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;Lapple/laf/JRSUIConstants$Orientation;Lapple/laf/JRSUIConstants$State;)V", methodCache: &AquaSliderUI.paintTrack_MethodID_14, args: &__args, locals: &__locals )
    }

    open func paintTrack( _ _arg0: java_awt.Graphics?, _ _arg1: javax_swing.JComponent?, _ _arg2: /* class apple.laf.JRSUIConstants$Orientation */ UnavailableObject?, _ _arg3: /* class apple.laf.JRSUIConstants$State */ UnavailableObject? ) {
        paintTrack( arg0: _arg0, arg1: _arg1, arg2: _arg2, arg3: _arg3 )
    }

    /// protected boolean com.apple.laf.AquaSliderUI.shouldUseArrowThumb()

    private static var shouldUseArrowThumb_MethodID_15: jmethodID?

    open func shouldUseArrowThumb() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "shouldUseArrowThumb", methodSig: "()Z", methodCache: &AquaSliderUI.shouldUseArrowThumb_MethodID_15, args: &__args, locals: &__locals )
