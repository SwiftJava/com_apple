...
open class AquaFocusHandler: java_swift.JavaObject, java_awt.FocusListener, /* java.beans.PropertyChangeListener */ UnclassedProtocol {
    ...
    private static var uninstall_MethodID_2: jmethodID?

    open class func uninstall( arg0: javax_swing.JComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "com/apple/laf/AquaFocusHandler", classCache: &AquaFocusHandlerJNIClass, methodName: "uninstall", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &uninstall_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    private static var isActive_MethodID_5: jmethodID?

    open class func isActive( arg0: javax_swing.JComponent? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticBooleanMethod( className: "com/apple/laf/AquaFocusHandler", classCache: &AquaFocusHandlerJNIClass, methodName: "isActive", methodSig: "(Ljavax/swing/JComponent;)Z", methodCache: &isActive_MethodID_5, args: &__args, locals: &__locals )
    ...
    open class func install( arg0: javax_swing.JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "com/apple/laf/AquaFocusHandler", classCache: &AquaFocusHandlerJNIClass, methodName: "install", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &install_MethodID_7, args: &__args, locals: &__locals )
    }
