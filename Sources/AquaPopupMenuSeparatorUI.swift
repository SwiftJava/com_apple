...
open class AquaPopupMenuSeparatorUI: javax_swing.BasicSeparatorUI {
    ...
    override open var highlight: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "highlight", fieldType: "Ljava/awt/Color;", fieldCache: &AquaPopupMenuSeparatorUI.highlight_FieldID, object: javaObject )
    ...
    override open var shadow: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "shadow", fieldType: "Ljava/awt/Color;", fieldCache: &AquaPopupMenuSeparatorUI.shadow_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Color( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaPopupMenuSeparatorUI", classCache: &AquaPopupMenuSeparatorUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func update( arg0: java_awt.Graphics?, arg1: javax_swing.JComponent? ) {
        ...
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        __args[1] = JNIType.toJava( value: arg1, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &AquaPopupMenuSeparatorUI.update_MethodID_5, args: &__args, locals: &__locals )
    }
