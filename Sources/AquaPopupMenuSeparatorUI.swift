...
open class AquaPopupMenuSeparatorUI: javax_swing.BasicSeparatorUI {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "com.apple.laf.AquaPopupMenuSeparatorUI", file, line ) {
            return nil
        }
    ...
    /// protected static com.apple.laf.AquaUtils$LazySingletonFromDefaultConstructor com.apple.laf.AquaPopupMenuSeparatorUI.instance
