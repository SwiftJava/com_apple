...
open class AquaScrollRegionBorder: AquaBorder {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "com.apple.laf.AquaScrollRegionBorder", file, line ) {
            return nil
        }
    ...
    /// static final com.apple.laf.AquaUtils$LazySingletonFromDefaultConstructor com.apple.laf.AquaScrollRegionBorder.instance
    ...
    private static var getScrollRegionBorder_MethodID_4: jmethodID?

    open class func getScrollRegionBorder() -> AquaScrollRegionBorder! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaScrollRegionBorder", classCache: &AquaScrollRegionBorderJNIClass, methodName: "getScrollRegionBorder", methodSig: "()Lcom/apple/laf/AquaScrollRegionBorder;", methodCache: &getScrollRegionBorder_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
