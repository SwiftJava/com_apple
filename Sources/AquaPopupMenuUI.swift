...
open class AquaPopupMenuUI: javax_swing.BasicPopupMenuUI {
    ...
    override open var popupMenu: javax_swing.JPopupMenu! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "popupMenu", fieldType: "Ljavax/swing/JPopupMenu;", fieldCache: &AquaPopupMenuUI.popupMenu_FieldID, object: javaObject )
    ...
    private static var paintRoundRect_MethodID_6: jmethodID?
    ...
    open func paintRoundRect( arg0: java_awt.Graphics2D?, arg1: java_awt.Rectangle? ) {
        ...
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        __args[1] = JNIType.toJava( value: arg1, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintRoundRect", methodSig: "(Ljava/awt/Graphics2D;Ljava/awt/Rectangle;)V", methodCache: &AquaPopupMenuUI.paintRoundRect_MethodID_6, args: &__args, locals: &__locals )
    }
