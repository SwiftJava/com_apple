...
open class AquaLabelUI: javax_swing.BasicLabelUI {
    ...
    private static var paintEnabledText_MethodID_2: jmethodID?
    ...
    open func paintEnabledText( arg0: javax_swing.JLabel?, arg1: java_awt.Graphics?, arg2: String?, arg3: Int, arg4: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintEnabledText", methodSig: "(Ljavax/swing/JLabel;Ljava/awt/Graphics;Ljava/lang/String;II)V", methodCache: &AquaLabelUI.paintEnabledText_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func paintDisabledText( arg0: javax_swing.JLabel?, arg1: java_awt.Graphics?, arg2: String?, arg3: Int, arg4: Int ) {
        ...
        __args[3] = JNIType.toJava( value: arg3, locals: &__locals )
        __args[4] = JNIType.toJava( value: arg4, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintDisabledText", methodSig: "(Ljavax/swing/JLabel;Ljava/awt/Graphics;Ljava/lang/String;II)V", methodCache: &AquaLabelUI.paintDisabledText_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var getDisabledLabelColor_MethodID_4: jmethodID?

    open func getDisabledLabelColor( arg0: javax_swing.JLabel? ) -> java_awt.Color! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDisabledLabelColor", methodSig: "(Ljavax/swing/JLabel;)Ljava/awt/Color;", methodCache: &AquaLabelUI.getDisabledLabelColor_MethodID_4, args: &__args, locals: &__locals )
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaLabelUI", classCache: &AquaLabelUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func installListeners( arg0: javax_swing.JLabel? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "(Ljavax/swing/JLabel;)V", methodCache: &AquaLabelUI.installListeners_MethodID_6, args: &__args, locals: &__locals )
    }
