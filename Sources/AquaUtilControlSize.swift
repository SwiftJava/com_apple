...
open class AquaUtilControlSize: java_swift.JavaObject {
    ...
    private static var removeSizePropertyListener_MethodID_2: jmethodID?

    open class func removeSizePropertyListener( arg0: javax_swing.JComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "com/apple/laf/AquaUtilControlSize", classCache: &AquaUtilControlSizeJNIClass, methodName: "removeSizePropertyListener", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &removeSizePropertyListener_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    private static var addSizePropertyListener_MethodID_6: jmethodID?

    open class func addSizePropertyListener( arg0: javax_swing.JComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "com/apple/laf/AquaUtilControlSize", classCache: &AquaUtilControlSizeJNIClass, methodName: "addSizePropertyListener", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &addSizePropertyListener_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var getUserSizeFrom_MethodID_7: jmethodID?

    open class func getUserSizeFrom( arg0: javax_swing.JComponent? ) -> /* apple.laf.JRSUIConstants$Size */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaUtilControlSize", classCache: &AquaUtilControlSizeJNIClass, methodName: "getUserSizeFrom", methodSig: "(Ljavax/swing/JComponent;)Lapple/laf/JRSUIConstants$Size;", methodCache: &getUserSizeFrom_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? /* apple.laf.JRSUIConstants$Size */ UnclassedObject( javaObject: __return ) : nil
    }
