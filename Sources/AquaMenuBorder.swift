...
open class AquaMenuBorder: java_swift.JavaObject, javax_swing.Border, javax_swing.UIResource {
    ...
    private static var getItemInsets_MethodID_2: jmethodID?

    open class func getItemInsets() -> java_awt.Insets! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaMenuBorder", classCache: &AquaMenuBorderJNIClass, methodName: "getItemInsets", methodSig: "()Ljava/awt/Insets;", methodCache: &getItemInsets_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getEmptyInsets_MethodID_3: jmethodID?

    open class func getEmptyInsets() -> java_awt.Insets! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaMenuBorder", classCache: &AquaMenuBorderJNIClass, methodName: "getEmptyInsets", methodSig: "()Ljava/awt/Insets;", methodCache: &getEmptyInsets_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Insets( javaObject: __return ) : nil
    }
    ...
    open func paintBorder( c: java_awt.Component?, g: java_awt.Graphics?, x: Int, y: Int, width: Int, height: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintBorder", methodSig: "(Ljava/awt/Component;Ljava/awt/Graphics;IIII)V", methodCache: &AquaMenuBorder.paintBorder_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func getBorderInsets( c: java_awt.Component? ) -> java_awt.Insets! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c != nil ? c! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBorderInsets", methodSig: "(Ljava/awt/Component;)Ljava/awt/Insets;", methodCache: &AquaMenuBorder.getBorderInsets_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Insets( javaObject: __return ) : nil
    }
