...
open class AquaSplitPaneDividerUI: javax_swing.BasicSplitPaneDivider {
    ...
    open func propertyChange( arg0: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &AquaSplitPaneDividerUI.propertyChange_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    override open func createLeftOneTouchButton() -> javax_swing.JButton! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createLeftOneTouchButton", methodSig: "()Ljavax/swing/JButton;", methodCache: &AquaSplitPaneDividerUI.createLeftOneTouchButton_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func createRightOneTouchButton() -> javax_swing.JButton! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createRightOneTouchButton", methodSig: "()Ljavax/swing/JButton;", methodCache: &AquaSplitPaneDividerUI.createRightOneTouchButton_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? javax_swing.JButton( javaObject: __return ) : nil
    }
    ...
    override open func paint( arg0: java_awt.Graphics? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &AquaSplitPaneDividerUI.paint_MethodID_8, args: &__args, locals: &__locals )
    }
