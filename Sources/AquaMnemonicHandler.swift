...
open class AquaMnemonicHandler: java_swift.JavaObject {
    ...
    private static var setMnemonicHidden_MethodID_3: jmethodID?

    open class func setMnemonicHidden( arg0: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "com/apple/laf/AquaMnemonicHandler", classCache: &AquaMnemonicHandlerJNIClass, methodName: "setMnemonicHidden", methodSig: "(Z)V", methodCache: &setMnemonicHidden_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var isMnemonicHidden_MethodID_4: jmethodID?

    open class func isMnemonicHidden() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticBooleanMethod( className: "com/apple/laf/AquaMnemonicHandler", classCache: &AquaMnemonicHandlerJNIClass, methodName: "isMnemonicHidden", methodSig: "()Z", methodCache: &isMnemonicHidden_MethodID_4, args: &__args, locals: &__locals )
