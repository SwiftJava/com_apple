...
open class AquaSpinnerUI: javax_swing.SpinnerUI {
    ...
    private static var replaceEditor_MethodID_2: jmethodID?
    ...
    open func replaceEditor( arg0: javax_swing.JComponent?, arg1: javax_swing.JComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "replaceEditor", methodSig: "(Ljavax/swing/JComponent;Ljavax/swing/JComponent;)V", methodCache: &AquaSpinnerUI.replaceEditor_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    private static var createPreviousButton_MethodID_3: jmethodID?

    open func createPreviousButton() -> /* com.apple.laf.AquaSpinnerUI$TransparentButton */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createPreviousButton", methodSig: "()Lcom/apple/laf/AquaSpinnerUI$TransparentButton;", methodCache: &AquaSpinnerUI.createPreviousButton_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var createNextButton_MethodID_4: jmethodID?

    open func createNextButton() -> /* com.apple.laf.AquaSpinnerUI$TransparentButton */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createNextButton", methodSig: "()Lcom/apple/laf/AquaSpinnerUI$TransparentButton;", methodCache: &AquaSpinnerUI.createNextButton_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? /* com.apple.laf.AquaSpinnerUI$TransparentButton */ UnclassedObject( javaObject: __return ) : nil
    }
    ...
    open func createEditor() -> javax_swing.JComponent! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createEditor", methodSig: "()Ljavax/swing/JComponent;", methodCache: &AquaSpinnerUI.createEditor_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var fixupEditor_MethodID_6: jmethodID?

    open func fixupEditor( arg0: javax_swing.JComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fixupEditor", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaSpinnerUI.fixupEditor_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func installUI( arg0: javax_swing.JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaSpinnerUI.installUI_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func getBaseline( arg0: javax_swing.JComponent?, arg1: Int, arg2: Int ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getBaseline", methodSig: "(Ljavax/swing/JComponent;II)I", methodCache: &AquaSpinnerUI.getBaseline_MethodID_8, args: &__args, locals: &__locals )
    ...
    open func getBaselineResizeBehavior( arg0: javax_swing.JComponent? ) -> java_awt.Component_BaselineResizeBehavior! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBaselineResizeBehavior", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Component$BaselineResizeBehavior;", methodCache: &AquaSpinnerUI.getBaselineResizeBehavior_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func uninstallUI( arg0: javax_swing.JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaSpinnerUI.uninstallUI_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var createLayout_MethodID_11: jmethodID?

    open func createLayout() -> java_awt.LayoutManager! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createLayout", methodSig: "()Ljava/awt/LayoutManager;", methodCache: &AquaSpinnerUI.createLayout_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createUI_MethodID_12: jmethodID?

    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaSpinnerUI", classCache: &AquaSpinnerUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func installDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "()V", methodCache: &AquaSpinnerUI.installDefaults_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func installListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &AquaSpinnerUI.installListeners_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "()V", methodCache: &AquaSpinnerUI.uninstallListeners_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallDefaults", methodSig: "()V", methodCache: &AquaSpinnerUI.uninstallDefaults_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    open func createPropertyChangeListener() -> /* java.beans.PropertyChangeListener */ UnclassedProtocol! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createPropertyChangeListener", methodSig: "()Ljava/beans/PropertyChangeListener;", methodCache: &AquaSpinnerUI.createPropertyChangeListener_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
