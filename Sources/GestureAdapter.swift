...
private typealias GestureAdapter_rotate_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func GestureAdapter_rotate_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias GestureAdapter_magnify_3_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func GestureAdapter_magnify_3( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias GestureAdapter_swipedDown_4_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func GestureAdapter_swipedDown_4( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias GestureAdapter_swipedLeft_5_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func GestureAdapter_swipedLeft_5( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias GestureAdapter_swipedRight_6_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func GestureAdapter_swipedRight_6( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias GestureAdapter_swipedUp_7_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func GestureAdapter_swipedUp_7( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias GestureAdapter_equals_11_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> jboolean

private func GestureAdapter_equals_11( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ arg0: jobject? ) -> jboolean {
    JNI.inNative = true;
...
private typealias GestureAdapter_toString_12_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong ) -> jobject?

private func GestureAdapter_toString_12( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong ) -> jobject? {
    JNI.inNative = true;
...
private typealias GestureAdapter_hashCode_13_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong ) -> jint

private func GestureAdapter_hashCode_13( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong ) -> jint {
    JNI.inNative = true;
...
open class GestureAdapterLocal_: JNIObjectProxy<GestureAdapter> {

    fileprivate static let _proxyClass: jclass = {
        var natives = [JNINativeMethod]()

        let GestureAdapter_rotate_0_thunk: GestureAdapter_rotate_0_type = GestureAdapter_rotate_0
        natives.append( JNINativeMethod( name: strdup("__rotate"), signature: strdup("(JLcom/apple/eawt/event/RotationEvent;)V"), fnPtr: unsafeBitCast( GestureAdapter_rotate_0_thunk, to: UnsafeMutableRawPointer.self ) ) )
        ...
        natives.append( JNINativeMethod( name: strdup("__magnify"), signature: strdup("(JLcom/apple/eawt/event/MagnificationEvent;)V"), fnPtr: unsafeBitCast( GestureAdapter_magnify_3_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let GestureAdapter_swipedDown_4_thunk: GestureAdapter_swipedDown_4_type = GestureAdapter_swipedDown_4
        natives.append( JNINativeMethod( name: strdup("__swipedDown"), signature: strdup("(JLcom/apple/eawt/event/SwipeEvent;)V"), fnPtr: unsafeBitCast( GestureAdapter_swipedDown_4_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let GestureAdapter_swipedLeft_5_thunk: GestureAdapter_swipedLeft_5_type = GestureAdapter_swipedLeft_5
        natives.append( JNINativeMethod( name: strdup("__swipedLeft"), signature: strdup("(JLcom/apple/eawt/event/SwipeEvent;)V"), fnPtr: unsafeBitCast( GestureAdapter_swipedLeft_5_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let GestureAdapter_swipedRight_6_thunk: GestureAdapter_swipedRight_6_type = GestureAdapter_swipedRight_6
        natives.append( JNINativeMethod( name: strdup("__swipedRight"), signature: strdup("(JLcom/apple/eawt/event/SwipeEvent;)V"), fnPtr: unsafeBitCast( GestureAdapter_swipedRight_6_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let GestureAdapter_swipedUp_7_thunk: GestureAdapter_swipedUp_7_type = GestureAdapter_swipedUp_7
        natives.append( JNINativeMethod( name: strdup("__swipedUp"), signature: strdup("(JLcom/apple/eawt/event/SwipeEvent;)V"), fnPtr: unsafeBitCast( GestureAdapter_swipedUp_7_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let GestureAdapter_equals_11_thunk: GestureAdapter_equals_11_type = GestureAdapter_equals_11
        natives.append( JNINativeMethod( name: strdup("__equals"), signature: strdup("(JLjava/lang/Object;)Z"), fnPtr: unsafeBitCast( GestureAdapter_equals_11_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let GestureAdapter_toString_12_thunk: GestureAdapter_toString_12_type = GestureAdapter_toString_12
        natives.append( JNINativeMethod( name: strdup("__toString"), signature: strdup("(J)Ljava/lang/String;"), fnPtr: unsafeBitCast( GestureAdapter_toString_12_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let GestureAdapter_hashCode_13_thunk: GestureAdapter_hashCode_13_type = GestureAdapter_hashCode_13
        natives.append( JNINativeMethod( name: strdup("__hashCode"), signature: strdup("(J)I"), fnPtr: unsafeBitCast( GestureAdapter_hashCode_13_thunk, to: UnsafeMutableRawPointer.self ) ) )
