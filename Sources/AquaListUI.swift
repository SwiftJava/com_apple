...
open class AquaListUI: javax_swing.BasicListUI {
    ...
    private static var getSourceListBackgroundPainter_MethodID_2: jmethodID?

    open class func getSourceListBackgroundPainter() -> javax_swing.Border! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaListUI", classCache: &AquaListUIJNIClass, methodName: "getSourceListBackgroundPainter", methodSig: "()Ljavax/swing/border/Border;", methodCache: &getSourceListBackgroundPainter_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getSourceListSelectionBackgroundPainter_MethodID_3: jmethodID?

    open class func getSourceListSelectionBackgroundPainter() -> javax_swing.Border! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaListUI", classCache: &AquaListUIJNIClass, methodName: "getSourceListSelectionBackgroundPainter", methodSig: "()Ljavax/swing/border/Border;", methodCache: &getSourceListSelectionBackgroundPainter_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? javax_swing.BorderForward( javaObject: __return ) : nil
    }
    ...
    private static var getListEvenBackgroundPainter_MethodID_5: jmethodID?

    open class func getListEvenBackgroundPainter() -> javax_swing.Border! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaListUI", classCache: &AquaListUIJNIClass, methodName: "getListEvenBackgroundPainter", methodSig: "()Ljavax/swing/border/Border;", methodCache: &getListEvenBackgroundPainter_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? javax_swing.BorderForward( javaObject: __return ) : nil
    }
    ...
    private static var getListOddBackgroundPainter_MethodID_6: jmethodID?

    open class func getListOddBackgroundPainter() -> javax_swing.Border! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaListUI", classCache: &AquaListUIJNIClass, methodName: "getListOddBackgroundPainter", methodSig: "()Ljavax/swing/border/Border;", methodCache: &getListOddBackgroundPainter_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? javax_swing.BorderForward( javaObject: __return ) : nil
    }
    ...
    override open func createMouseInputListener() -> javax_swing.MouseInputListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createMouseInputListener", methodSig: "()Ljavax/swing/event/MouseInputListener;", methodCache: &AquaListUI.createMouseInputListener_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var repaintCell_MethodID_8: jmethodID?
    ...
    open func repaintCell( arg0: java_swift.JavaObject?, arg1: Int, arg2: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "repaintCell", methodSig: "(Ljava/lang/Object;IZ)V", methodCache: &AquaListUI.repaintCell_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    override open func createFocusListener() -> java_awt.FocusListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFocusListener", methodSig: "()Ljava/awt/event/FocusListener;", methodCache: &AquaListUI.createFocusListener_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaListUI", classCache: &AquaListUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func installKeyboardActions() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installKeyboardActions", methodSig: "()V", methodCache: &AquaListUI.installKeyboardActions_MethodID_12, args: &__args, locals: &__locals )
    }
