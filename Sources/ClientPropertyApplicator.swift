...
open class ClientPropertyApplicator: java_swift.JavaObject, /* java.beans.PropertyChangeListener */ UnclassedProtocol {
    ...
    private static var removeFrom_MethodID_3: jmethodID?

    open func removeFrom( arg0: javax_swing.JComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeFrom", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &ClientPropertyApplicator.removeFrom_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var convertJComponentToTarget_MethodID_4: jmethodID?

    open func convertJComponentToTarget( arg0: javax_swing.JComponent? ) -> java_swift.JavaObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "convertJComponentToTarget", methodSig: "(Ljavax/swing/JComponent;)Ljava/lang/Object;", methodCache: &ClientPropertyApplicator.convertJComponentToTarget_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func propertyChange( evt: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &ClientPropertyApplicator.propertyChange_MethodID_5, args: &__args, locals: &__locals )
    }
