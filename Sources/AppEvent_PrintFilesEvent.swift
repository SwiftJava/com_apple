...
open class AppEvent_PrintFilesEvent: AppEvent_FilesEvent {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "com.apple.eawt.AppEvent$PrintFilesEvent", file, line ) {
            return nil
        }
    ...
    override open var source: java_lang.JavaObject! {
        get {
            ...
            let __value = JNIField.GetObjectField( fieldName: "source", fieldType: "Ljava/lang/Object;", fieldCache: &AppEvent_PrintFilesEvent.source_FieldID, object: javaObject, locals: &__locals )
