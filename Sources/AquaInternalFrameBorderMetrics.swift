...
open class AquaInternalFrameBorderMetrics: java_swift.JavaObject {
    ...
    open var buttonHeight: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "buttonHeight", fieldType: "I", fieldCache: &AquaInternalFrameBorderMetrics.buttonHeight_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
    ...
    open var buttonPadding: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "buttonPadding", fieldType: "I", fieldCache: &AquaInternalFrameBorderMetrics.buttonPadding_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var buttonWidth: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "buttonWidth", fieldType: "I", fieldCache: &AquaInternalFrameBorderMetrics.buttonWidth_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var downShift: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "downShift", fieldType: "I", fieldCache: &AquaInternalFrameBorderMetrics.downShift_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var font: java_awt.Font! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "font", fieldType: "Ljava/awt/Font;", fieldCache: &AquaInternalFrameBorderMetrics.font_FieldID, object: javaObject )
    ...
    open var leftSidePadding: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "leftSidePadding", fieldType: "I", fieldCache: &AquaInternalFrameBorderMetrics.leftSidePadding_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var titleBarHeight: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "titleBarHeight", fieldType: "I", fieldCache: &AquaInternalFrameBorderMetrics.titleBarHeight_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    private static var getMetrics_MethodID_1: jmethodID?
    ...
    open class func getMetrics( arg0: Bool ) -> AquaInternalFrameBorderMetrics! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaInternalFrameBorderMetrics", classCache: &AquaInternalFrameBorderMetricsJNIClass, methodName: "getMetrics", methodSig: "(Z)Lcom/apple/laf/AquaInternalFrameBorderMetrics;", methodCache: &getMetrics_MethodID_1, args: &__args, locals: &__locals )
    ...
    private static var initialize_MethodID_2: jmethodID?

    open func initialize() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "initialize", methodSig: "()V", methodCache: &AquaInternalFrameBorderMetrics.initialize_MethodID_2, args: &__args, locals: &__locals )
    }
