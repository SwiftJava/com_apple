...
open class AquaButtonExtendedTypes: java_lang.JavaObject {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "com.apple.laf.AquaButtonExtendedTypes", file, line ) {
            return nil
        }
    ...
    /// protected static final com.apple.laf.AquaUtils$LazySingleton com.apple.laf.AquaButtonExtendedTypes.typeDefinitions
    ...
    private static var getBorderForPosition_MethodID_2: jmethodID?

    open class func getBorderForPosition( arg0: javax_swing.AbstractButton?, arg1: java_lang.JavaObject?, arg2: java_lang.JavaObject? ) -> javax_swing.Border! {
        var __args = [jvalue]( repeating: jvalue(), count: 3 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        __args[2] = JNIType.encode( value: arg2, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaButtonExtendedTypes", classCache: &AquaButtonExtendedTypesJNIClass, methodName: "getBorderForPosition", methodSig: "(Ljavax/swing/AbstractButton;Ljava/lang/Object;Ljava/lang/Object;)Ljavax/swing/border/Border;", methodCache: &getBorderForPosition_MethodID_2, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? javax_swing.BorderForward( javaObject: __return ) : nil
    }

    open class func getBorderForPosition( _ _arg0: javax_swing.AbstractButton?, _ _arg1: java_lang.JavaObject?, _ _arg2: java_lang.JavaObject? ) -> javax_swing.Border! {
    ...
    private static var getSpecifierByName_MethodID_3: jmethodID?

    open class func getSpecifierByName( arg0: String? ) -> /* com.apple.laf.AquaButtonExtendedTypes$TypeSpecifier */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaButtonExtendedTypes", classCache: &AquaButtonExtendedTypesJNIClass, methodName: "getSpecifierByName", methodSig: "(Ljava/lang/String;)Lcom/apple/laf/AquaButtonExtendedTypes$TypeSpecifier;", methodCache: &getSpecifierByName_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getAllTypes_MethodID_4: jmethodID?

    open class func getAllTypes() -> java_util.Map! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaButtonExtendedTypes", classCache: &AquaButtonExtendedTypesJNIClass, methodName: "getAllTypes", methodSig: "()Ljava/util/Map;", methodCache: &getAllTypes_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getRealPositionForLogicalPosition_MethodID_5: jmethodID?
