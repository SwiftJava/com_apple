...
open class AppEvent_ScreenSleepEvent: AppEvent {
    ...
    override open var source: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "source", fieldType: "Ljava/lang/Object;", fieldCache: &AppEvent_ScreenSleepEvent.source_FieldID, object: javaObject )
