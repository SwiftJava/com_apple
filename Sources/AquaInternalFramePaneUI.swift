...
open class AquaInternalFramePaneUI: javax_swing.BasicDesktopPaneUI, java_awt.MouseListener {
    ...
    override open var closeKey: javax_swing.KeyStroke! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "closeKey", fieldType: "Ljavax/swing/KeyStroke;", fieldCache: &AquaInternalFramePaneUI.closeKey_FieldID, object: javaObject )
    ...
    override open var desktop: javax_swing.JDesktopPane! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "desktop", fieldType: "Ljavax/swing/JDesktopPane;", fieldCache: &AquaInternalFramePaneUI.desktop_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var desktopManager: javax_swing.DesktopManager! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "desktopManager", fieldType: "Ljavax/swing/DesktopManager;", fieldCache: &AquaInternalFramePaneUI.desktopManager_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var maximizeKey: javax_swing.KeyStroke! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "maximizeKey", fieldType: "Ljavax/swing/KeyStroke;", fieldCache: &AquaInternalFramePaneUI.maximizeKey_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? javax_swing.KeyStroke( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var minimizeKey: javax_swing.KeyStroke! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "minimizeKey", fieldType: "Ljavax/swing/KeyStroke;", fieldCache: &AquaInternalFramePaneUI.minimizeKey_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? javax_swing.KeyStroke( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var navigateKey: javax_swing.KeyStroke! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "navigateKey", fieldType: "Ljavax/swing/KeyStroke;", fieldCache: &AquaInternalFramePaneUI.navigateKey_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? javax_swing.KeyStroke( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var navigateKey2: javax_swing.KeyStroke! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "navigateKey2", fieldType: "Ljavax/swing/KeyStroke;", fieldCache: &AquaInternalFramePaneUI.navigateKey2_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? javax_swing.KeyStroke( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaInternalFramePaneUI", classCache: &AquaInternalFramePaneUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func installUI( arg0: javax_swing.JComponent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaInternalFramePaneUI.installUI_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func mouseClicked( e: java_awt.MouseEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseClicked", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaInternalFramePaneUI.mouseClicked_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func mouseExited( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseExited", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaInternalFramePaneUI.mouseExited_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    override open func uninstallDesktopManager() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallDesktopManager", methodSig: "()V", methodCache: &AquaInternalFramePaneUI.uninstallDesktopManager_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallUI( arg0: javax_swing.JComponent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaInternalFramePaneUI.uninstallUI_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    open func update( arg0: java_awt.Graphics?, arg1: javax_swing.JComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &AquaInternalFramePaneUI.update_MethodID_12, args: &__args, locals: &__locals )
    }
