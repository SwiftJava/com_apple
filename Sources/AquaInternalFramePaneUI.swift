...
open class AquaInternalFramePaneUI: javax_swing.BasicDesktopPaneUI, java_awt.MouseListener {
    ...
    private static var mousePressed_MethodID_3: jmethodID?

    open func mousePressed( e: java_awt.MouseEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mousePressed", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaInternalFramePaneUI.mousePressed_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var mouseReleased_MethodID_4: jmethodID?

    open func mouseReleased( e: java_awt.MouseEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseReleased", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaInternalFramePaneUI.mouseReleased_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func mouseExited( e: java_awt.MouseEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseExited", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaInternalFramePaneUI.mouseExited_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func mouseEntered( e: java_awt.MouseEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseEntered", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaInternalFramePaneUI.mouseEntered_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func installUI( arg0: javax_swing.JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaInternalFramePaneUI.installUI_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallUI( arg0: javax_swing.JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &AquaInternalFramePaneUI.uninstallUI_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    override open func installDesktopManager() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDesktopManager", methodSig: "()V", methodCache: &AquaInternalFramePaneUI.installDesktopManager_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    override open func uninstallDesktopManager() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallDesktopManager", methodSig: "()V", methodCache: &AquaInternalFramePaneUI.uninstallDesktopManager_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaInternalFramePaneUI", classCache: &AquaInternalFramePaneUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_12, args: &__args, locals: &__locals )
