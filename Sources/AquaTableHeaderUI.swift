...
open class AquaTableHeaderUI: javax_swing.BasicTableHeaderUI {
    ...
    private static var getTableColumn_MethodID_2: jmethodID?
    ...
    open class func getTableColumn( arg0: javax_swing.JTableHeader?, arg1: java_swift.JavaObject? ) -> javax_swing.TableColumn! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaTableHeaderUI", classCache: &AquaTableHeaderUIJNIClass, methodName: "getTableColumn", methodSig: "(Ljavax/swing/table/JTableHeader;Ljava/lang/Object;)Ljavax/swing/table/TableColumn;", methodCache: &getTableColumn_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func getPreferredSize( arg0: javax_swing.JComponent? ) -> java_awt.Dimension! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreferredSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &AquaTableHeaderUI.getPreferredSize_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getMinimumSize( arg0: javax_swing.JComponent? ) -> java_awt.Dimension! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMinimumSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &AquaTableHeaderUI.getMinimumSize_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
