...
open class AquaCaret: javax_swing.DefaultCaret, javax_swing.UIResource {
    ...
    open func focusGained( arg0: java_awt.FocusEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "focusGained", methodSig: "(Ljava/awt/event/FocusEvent;)V", methodCache: &AquaCaret.focusGained_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func focusLost( arg0: java_awt.FocusEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "focusLost", methodSig: "(Ljava/awt/event/FocusEvent;)V", methodCache: &AquaCaret.focusLost_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func mousePressed( arg0: java_awt.MouseEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mousePressed", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &AquaCaret.mousePressed_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func paint( arg0: java_awt.Graphics? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &AquaCaret.paint_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var setVisible_MethodID_6: jmethodID?

    open func setVisible( arg0: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setVisible", methodSig: "(Z)V", methodCache: &AquaCaret.setVisible_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func propertyChange( evt: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &AquaCaret.propertyChange_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    override open func fireStateChanged() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireStateChanged", methodSig: "()V", methodCache: &AquaCaret.fireStateChanged_MethodID_8, args: &__args, locals: &__locals )
    }


    /// protected synchronized void com.apple.laf.AquaCaret.damage(java.awt.Rectangle)

    private static var damage_MethodID_9: jmethodID?

    open func damage( arg0: java_awt.Rectangle? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "damage", methodSig: "(Ljava/awt/Rectangle;)V", methodCache: &AquaCaret.damage_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    override open func getSelectionPainter() -> javax_swing.Highlighter_HighlightPainter! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectionPainter", methodSig: "()Ljavax/swing/text/Highlighter$HighlightPainter;", methodCache: &AquaCaret.getSelectionPainter_MethodID_10, args: &__args, locals: &__locals )
