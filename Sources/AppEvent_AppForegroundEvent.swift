...
open class AppEvent_AppForegroundEvent: AppEvent {
    ...
    private static var AppEvent_AppForegroundEventJNIClass: jclass?
    ...
    override open var source: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "source", fieldType: "Ljava/lang/Object;", fieldCache: &AppEvent_AppForegroundEvent.source_FieldID, object: javaObject )
