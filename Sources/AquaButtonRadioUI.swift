...
open class AquaButtonRadioUI: AquaButtonLabeledUI {
    ...
    private static var getSizingRadioButtonIcon_MethodID_2: jmethodID?

    open class func getSizingRadioButtonIcon() -> javax_swing.Icon! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaButtonRadioUI", classCache: &AquaButtonRadioUIJNIClass, methodName: "getSizingRadioButtonIcon", methodSig: "()Ljavax/swing/Icon;", methodCache: &getSizingRadioButtonIcon_MethodID_2, args: &__args, locals: &__locals )
    ...
    override open class func createUI( arg0: javax_swing.JComponent? ) -> javax_swing.ComponentUI! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/apple/laf/AquaButtonRadioUI", classCache: &AquaButtonRadioUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getPropertyPrefix() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPropertyPrefix", methodSig: "()Ljava/lang/String;", methodCache: &AquaButtonRadioUI.getPropertyPrefix_MethodID_4, args: &__args, locals: &__locals )
    ...
    override open func getPainter() -> AquaButtonBorder! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPainter", methodSig: "()Lcom/apple/laf/AquaButtonBorder;", methodCache: &AquaButtonRadioUI.getPainter_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
